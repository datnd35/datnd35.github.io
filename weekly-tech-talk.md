---
layout: default
title: 🎙️ Weekly Tech Talk
permalink: /weekly-tech-talk/
---
...
<div class="lt-hero">
  <h1>🎙️ Weekly Tech Talk</h1>
  <p>Tổng hợp các chủ đề tech talk hằng tuần: engineering practices, architecture, leadership, và bài học thực chiến.</p>
</div>

{% assign all_posts = site["weekly-tech-talk"] | sort: 'date' | reverse %}
...
<div class="lt-section">
  ...
  <ul class="lt-track-list">
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('wtt-updates', this)">
        Weekly Sessions <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="wtt-updates">
        <ul>
          ...
          {% endfor %}
          {% if all_posts.size == 0 %}<li><span class="empty">Chưa có bài viết. Thêm bài trong thư mục <code>_weekly-tech-talk/</code> để tự động hiển thị tại đây.</span></li>{% endif %}
        </ul>
      </div>
    </li>
