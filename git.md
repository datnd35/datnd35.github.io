...
<div class="lt-hero">
  <h1>Learning Tracks: Git</h1>
  <p>Version control, workflows, strategies, collaboration patterns và Git best practices cho Senior/Tech Lead.</p>
</div>

{% assign all_posts = site.git | sort: 'date' | reverse %}
{% assign enterprise_posts = all_posts | where: "track", "git-enterprise" %}
...
<div class="lt-section">
  ...
  <ul class="lt-track-list">
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('git-enterprise', this)">
        Git Enterprise &amp; Case Studies <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="git-enterprise">
        <ul>
