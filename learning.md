...
<div class="lt-hero">
  <h1>Learning Tracks: How to Learn Better</h1>
  <p>Phương pháp học tập, tư duy chiến lược, kỹ năng tiếng Anh và các công cụ hỗ trợ developer phát triển bản thân.</p>
</div>

{% assign all_posts = site.learning | sort: 'date' | reverse %}
{% assign method_posts  = all_posts | where: "track", "learning-methods" %}
{% assign english_posts = all_posts | where: "track", "english" %}
{% assign tools_posts   = all_posts | where: "track", "tools-resources" %}
...
<div class="lt-section">
  ...
  <ul class="lt-track-list">
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('learn-methods', this)">
        Learning Methods &amp; Strategic Thinking <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="learn-methods">
        <ul>
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('learn-english', this)">
        English for Developers <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="learn-english">
        <ul>
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('learn-tools', this)">
        Tools &amp; Resources (Flutter, Copilot) <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="learn-tools">
        <ul>
