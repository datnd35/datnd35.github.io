...
<div class="lt-hero">
  <h1>Learning Tracks: Cloud &amp; DevOps</h1>
...
<div class="lt-section">
  ...
  <ul class="lt-track-list">
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('cloud-fund', this)">
        Cloud Fundamentals (Docker, Kubernetes) <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="cloud-fund">
        <ul>
          {% for post in cloud_fund_posts %}
          <li>
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('cloud-aws-core', this)">
        AWS Core Services (IAM, EC2, VPC, Route53) <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="cloud-aws-core">
        <ul>
          {% for post in aws_core_posts %}
          <li>
            <span class="post-date">{{ post.date | date: "%Y-%m-%d" }}</span>
            <a href="{{ post.url }}">{{ post.title }}</a>
          </li>
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('cloud-aws-adv', this)">
        AWS Advanced (Lambda, ECS, EKS, CloudFront, CloudWatch) <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="cloud-aws-adv">
        <ul>
          {% for post in aws_adv_posts %}
          <li>
            <span class="post-date">{{ post.date | date: "%Y-%m-%d" }}</span>
            <a href="{{ post.url }}">{{ post.title }}</a>
          </li>
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('cloud-iac', this)">
        Infrastructure as Code &amp; CI/CD (CloudFormation, Terraform, CodePipeline) <span class="arrow">▶</span>
      </button>
