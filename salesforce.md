...
<div class="lt-section">
  ...
  <ul class="lt-track-list">
    ...
    <li class="lt-track-item">
      ...
      <div class="lt-panel" id="sf-fundamentals">
        <ul>
          {% for post in sf_fundamentals %}
          <li>
    ...
    <li class="lt-track-item">
      ...
      <div class="lt-panel" id="sf-development">
        <ul>
          {% for post in sf_dev %}
          <li>
            <span class="post-date">{{ post.date | date: "%Y-%m-%d" }}</span>
    ...
    <li class="lt-track-item">
      ...
      <div class="lt-panel" id="sf-integration">
        <ul>
          {% for post in sf_integration %}
          <li>
            <span class="post-date">{{ post.date | date: "%Y-%m-%d" }}</span>
            <a href="{{ post.url | relative_url }}">{{ post.title }}</a>
          </li>
