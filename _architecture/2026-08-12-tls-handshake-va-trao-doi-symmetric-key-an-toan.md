...
section: "security"
description: "TLS/HTTPS handshake dùng asymmetric encryption để trao đổi symmetric session key an toàn, sau đó dùng symmetric encryption cho truyền dữ liệu hiệu năng cao."
---
