...
<div class="lt-hero">
  <h1>Learning Tracks: Senior Engineer</h1>
  <p>Tư duy, kỹ năng và kinh nghiệm thực chiến để trở thành Senior/Staff Engineer — từ mindset đến testing, tooling, people skills và enterprise leadership.</p>
</div>
...
<div class="lt-section">
  <h2>1. Engineering Excellence</h2>
  <ul class="lt-track-list">

    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('sr-mindset', this)">
        Senior Mindset &amp; System Design Thinking <span class="arrow">▶</span>
      </button>
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('sr-workflow', this)">
        Tools &amp; Workflow (Git, Copilot, PR Review, CI/CD, Scrum) <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="sr-workflow">
        <ul>
          {% for post in workflow_posts %}
          <li>
            <span class="post-date">{{ post.date | date: "%Y-%m-%d" }}</span>
            <a href="{{ post.url }}">{{ post.title }}</a>
          </li>
...
<div class="lt-section">
  <h2>2. People &amp; Enterprise Leadership</h2>
  <ul class="lt-track-list">

    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('sr-people', this)">
        People &amp; Team Leadership <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="sr-people">
        <ul>
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('sr-enterprise', this)">
        Enterprise &amp; Cross-Functional Leadership <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="sr-enterprise">
        <ul>
          {% for post in enterprise_posts %}
          <li>
            <span class="post-date">{{ post.date | date: "%Y-%m-%d" }}</span>
            <a href="{{ post.url }}">{{ post.title }}</a>
          </li>
