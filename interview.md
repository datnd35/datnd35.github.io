...
<div class="lt-hero">
  <h1>Learning Tracks: Interview Preparation</h1>
  <p>Chuẩn bị phỏng vấn có hệ thống — từ tư duy interview đến câu hỏi kỹ thuật Frontend theo từng chủ đề.</p>
</div>

{% assign all_posts = site.interview | sort: 'date' | reverse %}
{% assign mindset_posts  = all_posts | where: "track", "interview-mindset" %}
{% assign frontend_posts = all_posts | where: "track", "frontend-interview" %}
...
<div class="lt-section">
  ...
  <ul class="lt-track-list">
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('iv-mindset', this)">
        Interview Mindset &amp; Framework <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="iv-mindset">
        <ul>
    ...
    <li class="lt-track-item">
      <button class="lt-track-btn" onclick="togglePanel('iv-frontend', this)">
        Frontend Interview Questions (HTML, CSS, JS, Network, Performance, Testing) <span class="arrow">▶</span>
      </button>
      <div class="lt-panel" id="iv-frontend">
        <ul>
